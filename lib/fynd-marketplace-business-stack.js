...
class FyndMarketplaceBusinessStack extends Stack {
    constructor(scope, id, props) {
        ...
        const lambdaRole = iam.Role.fromRoleArn(this, 'ImportedLambdaRole', `arn:aws:iam::${props.env.account}:role/${props.resourcePrefix}LambdaRole`, {
            mutable: false,
        });
        ...
        const bucket = new s3.Bucket(this, `${resourcePrefix}Fynd_Nice_OMS_Sync_Bucket`, {
        ...
        fyndOMSOrderExportLambda.addEventSource(new cdk.aws_lambda_event_sources.SqsEventSource(fyndOrderExportSQS, {
            batchSize: 1,
            enabled: true
        }));
